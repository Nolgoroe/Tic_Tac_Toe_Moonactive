...
public class UndoSystem : MonoBehaviour
{
    ...
    //This will then give me the option to iterate through an X amount of elements in the list and just call the "Unmark" func on those cells.
